...
namespace PaginaEEST1.Data.Migrations
{
    ...
    [Migration("20250308054911_AddPreceptorAndSecretaryRoles")]
    partial class AddPreceptorAndSecretaryRoles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaginaEEST1.Data.Models.PhysicalObjects.ComputerMonitor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PaginaEEST1.Data.Models.SchoolArea.Assets.AvailableSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ReservableAreaId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ReservableAreaId");

                    b.ToTable("AvailableSchedules");
                });

            modelBuilder.Entity("PaginaEEST1.Data.Models.SchoolArea.Assets.ReservableArea", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReservableAreas");
                });

            modelBuilder.Entity("PaginaEEST1.Data.Models.SchoolArea.Assets.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PaginaEEST1.Data.Models.SchoolEnrollment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PaginaEEST1.Data.Models.People.Preceptor", b =>
                {
            ...
            modelBuilder.Entity("PaginaEEST1.Data.Models.People.Secretary", b =>
                {
                    b.HasBaseType("PaginaEEST1.Data.Models.People.SchoolEmployee");
            ...
            modelBuilder.Entity("PaginaEEST1.Data.Models.SchoolArea.Assets.AvailableSchedule", b =>
                {
                    b.HasOne("PaginaEEST1.Data.Models.SchoolArea.Assets.ReservableArea", null)
                        .WithMany("AvailableSchedules")
                        .HasForeignKey("ReservableAreaId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("PaginaEEST1.Data.Models.SchoolArea.Assets.ReservableArea", b =>
                {
                    b.HasOne("PaginaEEST1.Data.Models.SchoolArea.Area", null)
                        .WithOne("ReservableInfo")
                        .HasForeignKey("PaginaEEST1.Data.Models.SchoolArea.Assets.ReservableArea", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PaginaEEST1.Data.Models.PhysicalObjects.Desktop", b =>
                {
                    ...
                    b.HasOne("PaginaEEST1.Data.Models.PhysicalObjects.ComputerMonitor", "Monitor")
                        .WithMany()
